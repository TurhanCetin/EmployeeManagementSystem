...
public class UserController {
    ...
    private String logOutManager(HttpSession session, Cookie cookie){
        session.setAttribute("loginManager",null);
        return "redirect:/personnel/login";
    }

    @PostMapping("/personnel/self/update")
    public String selfUpdateManager(RedirectAttributes redirectAttributes, User user){
        service.edit(user);
        redirectAttributes.addFlashAttribute("message" , "Personnel was edit successfully");
        return "Pages/managerHome";
    }
